...
public protocol ProcessArgumentParser {
 ...
 */
public protocol ProcessArgumentReader: class, ProcessArgumentParser {
    ...
    /// This is used to retrieve the relevant arguments in the subcommands.
...
public extension ProcessArgumentReader {
